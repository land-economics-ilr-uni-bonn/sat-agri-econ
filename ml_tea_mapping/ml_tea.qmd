...
subtitle: |
  **Supervised Machine Learning Tutorial**
  ...
  _[Land Economics Group, Institute for Food and Resource Economics, University of Bonn, Bonn, Germany](https://www.ilr1.uni-bonn.de/en/research/research-groups/land-economics)_
...
In this tutorial, we demonstrate how to map tea plantations in a small region at the foot of Mount Kenya by combining Sentinel-2 satellite imagery, true presence and absence field data, and random forest machine learning techniques implemented in **R** [@rcoreteam2025]. We focus on workflow that spans from data preparation and model training to prediction and visualization of binary maps.
